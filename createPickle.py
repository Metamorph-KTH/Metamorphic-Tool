...
labelTrainList =[]
labelTestList = []
with open('/home/aravind/metamorphic/maltesque/labels/additive/additive_dataLabel_org_m2.csv', 'r') as csvFile:
...
nx.write_gpickle(gList, "/home/aravind/metamorphic/maltesque/gPickles/additive/additive_org_m2.gpickle")

with open('/home/aravind/metamorphic/maltesque/labels/additive/final_labels/additive_org_m2.txt', 'w') as f:
